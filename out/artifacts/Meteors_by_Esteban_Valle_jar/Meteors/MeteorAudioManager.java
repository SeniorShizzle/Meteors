...
public class MeteorAudioManager {
    ...
    private MeteorAudioManager() {
        ...
        try {
            low =       Applet.newAudioClip(new URL("file:low.wav"));
            high =      Applet.newAudioClip(new URL("file:high.wav"));
            saucer =    Applet.newAudioClip(new URL("file:saucer_woo.wav"));
            fire =      Applet.newAudioClip(new URL("file:pew.wav"));
            explosionLow =     Applet.newAudioClip(new URL("file:explosion.wav"));
            explosionHigh =    Applet.newAudioClip(new URL("file:explosion_high.wav"));
            explosionMedium =  Applet.newAudioClip(new URL("file:explosion_medium.wav"));
            gameOver =  Applet.newAudioClip(new URL("file:" + filename));
            thrust =    Applet.newAudioClip(new URL("file:engines.wav"));
            aTheme =    Applet.newAudioClip(new URL("file:meteor_a_theme.wav"));
            aTheme240 = Applet.newAudioClip(new URL("file:meteor_a_theme_240.wav"));
